...
fun Story.toEntity(): StoryEntity =
    StoryEntity(storyId, name, shortSummary, fullSummary)

fun Character.toEntity(storyId: Long) =
    CharacterEntity(characterId, image?.resourceUri, name, storyId)

fun PreviewMedia.toEntity(storyId: Long) =
    PreviewMediaEntity(resourceId = resourceId, resourceUri = resourceUri, resourceType = resourceType, storyId = storyId)